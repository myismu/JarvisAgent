...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            command::session::clear_active_session_id,
            command::session::set_session_work_mode,
            command::session::get_session_work_mode,
            command::session::list_sessions,
            command::session::create_session,
            command::session::open_project,
            command::session::list_projects,
            ...
            command::app_config::clear_custom_window_states,
            command::app_config::get_custom_window_state,
            command::app_config::list_custom_window_states,
            command::app_config::save_custom_window_state,
            command::app_config::get_ui_preferences,
            command::app_config::save_ui_preferences,
            command::app_config::get_skill_activations,
            command::app_config::set_skill_active,
