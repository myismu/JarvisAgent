...
JarvisAgent is a Tauri 2.0 + Vue 3 desktop AI coding assistant. Frontend is TypeScript/Pinia, backend is Rust/Tokio. Supports 20+ LLM models across DeepSeek, Codex, GPT, Gemini, Qwen, and others.
